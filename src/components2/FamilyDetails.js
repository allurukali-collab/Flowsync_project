...
import {
  ...
  Select, MenuItem, Breadcrumbs, Link, Table, TableBody, TableCell, TableContainer, TableHead, TableRow
} from '@mui/material';
  ...
  return (
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      ...
      <Box sx={{ minHeight: '100vh', backgroundColor: 'transparent' }}>
        <Box sx={{ borderRadius: '5px', backgroundColor: 'rgba(255,255,255,0.3)', p: 3, maxWidth: '1200px', mx: 'auto' }}>
          <Box display="flex" justifyContent="space-between" alignItems="center" sx={{ mb: 2 }}>
            <Breadcrumbs aria-label="breadcrumb" separator=">" sx={{ '& .MuiBreadcrumbs-separator': { color: 'rgba(255,255,255,0.4)' } }}>
              ...
              <Typography color="rgba(255,255,255,0.7)" fontWeight={600}>Family Details</Typography>
            </Breadcrumbs>
        ...
        <TableContainer component={Paper} sx={{ mt: 4, mx: 'auto', maxWidth: '1200px', borderRadius: 2 }}>
  <Table sx={{ minWidth: 650 }} aria-label="family details table">
    <TableHead>
